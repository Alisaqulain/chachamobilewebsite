  ...
  return (
    <div className="page-3d-enter mx-auto max-w-3xl px-4 py-10 md:py-14">
      ...
      <ul className="mt-8 list-disc space-y-4 pl-5 text-sm leading-relaxed text-white/75">
        <li>
          <strong className="text-white">No customer accounts.</strong> This website does not
          require login or signup for shopping. We do not operate a traditional user account system
          for buyers.
        </li>
        <li>
          <strong className="text-white">Cart data.</strong> Your cart is stored locally in your
          browser (localStorage) on your device. It is not sent to our servers.
        </li>
        <li>
          <strong className="text-white">WhatsApp for communication.</strong> When you contact us
        ...
        <li>
          <strong className="text-white">Admin access.</strong> Staff may access product and
