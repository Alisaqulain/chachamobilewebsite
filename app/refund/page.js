...
export default function RefundPage() {
  return (
    <div className="page-3d-enter mx-auto max-w-3xl px-4 py-10 md:py-14">
      <h1 className="text-3xl font-extrabold text-white">Return & Refund Policy</h1>
      ...
      <ul className="mt-8 list-disc space-y-4 pl-5 text-sm leading-relaxed text-white/75">
        <li>
          <strong className="text-white">Defective items only.</strong> Replacement or repair
        ...
        <li>
          <strong className="text-white">No refund on installed parts.</strong> Once a part has
        ...
        <li>
          <strong className="text-white">How to report.</strong> Share clear photos/videos on
          WhatsApp and keep the original packaging where possible. Our team will guide next steps.
        </li>
        <li>
          <strong className="text-white">Final decision.</strong> Eligibility for replacement or
