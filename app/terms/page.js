  ...
  return (
    <div className="page-3d-enter mx-auto max-w-3xl px-4 py-10 md:py-14">
      ...
      <ul className="mt-8 list-disc space-y-4 pl-5 text-sm leading-relaxed text-white/75">
        <li>
          <strong className="text-white">No return without checking.</strong> Please verify the
        ...
        <li>
          <strong className="text-white">Product quality disclaimer.</strong> Product quality
        ...
        <li>
          <strong className="text-white">Pricing subject to change.</strong> Prices on the
        ...
        <li>
          <strong className="text-white">Orders.</strong> Sending a WhatsApp message does not
