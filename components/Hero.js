...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-black/10 bg-gradient-to-br from-brand via-brand-bright to-brand-dim p-8 text-black shadow-xl md:p-12">
      ...
      <div className="relative max-w-2xl">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/shop"
            className="inline-flex items-center justify-center rounded-full bg-black px-6 py-3 text-sm font-bold text-brand shadow-lg transition hover:bg-black/90"
          >
            Browse shop
          </Link>
          <a
