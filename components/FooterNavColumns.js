  ...
  return (
    <>
      <div className="col-span-2 sm:col-span-1">
        ...
        <ul className="mt-4 columns-2 gap-x-4 text-sm text-white/80 sm:columns-1">
          {categories.map((c) => (
      ...
      <div>
        ...
        <ul className="mt-4 max-h-64 space-y-2 overflow-y-auto pr-1 text-sm text-white/80 sm:max-h-none">
          {brandRows.map((b) => {
